...
项目已完成遗留系统分析、总体重构设计、首次初始化、账号认证、项目成员权限，以及视频导入、采样、抽帧和帧筛选主链路。FastAPI 提供受管媒体与帧 API，独立 Worker 负责复制、yt-dlp 下载和 FFmpeg 抽帧，Vue 3 提供项目视频工作区、采样配置、帧筛选和任务管理界面。
